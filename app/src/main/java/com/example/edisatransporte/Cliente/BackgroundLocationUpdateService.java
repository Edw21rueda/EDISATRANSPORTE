...
import com.example.edisatransporte.viaje.InfvActivity;
...
public class BackgroundLocationUpdateService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    */
    ...
    private void StartForeground() {
        Intent intent = new Intent(context, InfvActivity.class);
        ...
        builder.setContentTitle("VIAJE EN CURSO");
    ...
    public void onLocationChanged(Location location) {
        ...
        mireferencia.child("Incidentes").child("1090").child("latitud").setValue(location.getLatitude());
        mireferencia.child("Incidentes").child("1090").child("longitud").setValue(location.getLongitude());
        mireferencia.child("Incidentes").child("1090").child("velocidad").setValue(location.getSpeed());
