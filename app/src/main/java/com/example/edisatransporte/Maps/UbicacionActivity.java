package com.example.edisatransporte.Maps;
...
import com.example.edisatransporte.BuildConfig;
...
public class UbicacionActivity extends AppCompatActivity implements
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_PERMISSIONS_REQUEST_CODE) {
            if (grantResults.length <= 0) {
                ...
                // Permission denied.
                Snackbar.make(
                        findViewById(R.id.activity_ubicacion),
                            ...
                            switch (statusCode) {
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        ...
                                        rae.startResolutionForResult(UbicacionActivity.this, REQUEST_CHECK_SETTINGS);
                                ...
                                case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                    ...
                                    Toast.makeText(UbicacionActivity.this, errorMessage, Toast.LENGTH_LONG).show();
    ...
    public void updateTextField(Context context) {
        mireferencia.child("Viajes").child(sr).child("horaencurso").setValue(LocationRequestHelper.getInstance(context).getStringValue("hora",""));
        mireferencia.child("Viajes").child(sr).child("longitud").setValue(LocationRequestHelper.getInstance(context).getStringValue("longitude",""));
        mireferencia.child("Viajes").child(sr).child("velocidad").setValue(LocationRequestHelper.getInstance(context).getStringValue("velocidad",""));
        mireferencia.child("Viajes").child(sr).child("direccionenviaje").setValue(LocationRequestHelper.getInstance(context).getStringValue("direccion",""));
        mireferencia.child("Viajes").child(sr).child("latitud").setValue(LocationRequestHelper.getInstance(context).getStringValue("latitud",""));
